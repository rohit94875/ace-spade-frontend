...
export const TIER_CATALOG: TierCatalogEntry[] = [
  ...
  { name: 'Silver 3', family: 'silver', familyLabel: 'Silver', color: '#E2E2E2', mmr: '1350 – 1399', division: 3 },
  { name: 'Silver 2', family: 'silver', familyLabel: 'Silver', color: '#D1D1D1', mmr: '1400 – 1449', division: 2 },
  { name: 'Silver 1', family: 'silver', familyLabel: 'Silver', color: '#C0C0C0', mmr: '1450 – 1499', division: 1 },
